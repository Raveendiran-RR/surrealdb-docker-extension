...
echo "╔════════════════════════════════════════════════════════╗"
echo "║   SurrealDB Extension - Fix 403 Forbidden             ║"
echo "╚════════════════════════════════════════════════════════╝"
echo ""
...
curl -X POST http://localhost:8001/sql \
  ...
  -u root:root \
  -d "USE NS test; USE DB test; INFO FOR DB;" 2>&1 | head -20

echo ""
echo ""
echo "📝 Updating QueryEditor with Basic Authentication..."
...
echo "╚══════════════════════════════════════════════════╝"
echo ""
echo "🎯 Added: Authorization: Basic base64(root:root)"
echo "📋 Test in Query Editor now!"
echo ""
